...
public class UnusedTicketAdapter extends RecyclerView.Adapter<UnusedTicketAdapter.UnusedTicketViewHolder> {
    SimpleDateFormat dateFormat = new SimpleDateFormat("dd/MM/yyyy", Locale.getDefault());

    public List<TransactionModel> transactionModelList;
    public Context context;

    public UnusedTicketAdapter(Context context) {
    ...
    @NonNull
    @Override
    public UnusedTicketViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.ticket_item, parent, false);
        return new UnusedTicketViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull UnusedTicketViewHolder holder, int position) {
        ...
        String qrCode = "THISISVMUSEUMQRCODE " + transactionModel.getNumberOfTickets() + "tickets_transID" + transactionModel.getID();
    ...
    public class UnusedTicketViewHolder extends RecyclerView.ViewHolder {
        TextView date, id, amount;
        ImageView qrCode;
        LinearLayout ticketItem;

        public UnusedTicketViewHolder(View itemView) {
            super(itemView);
