...
public class ExhibitDetailsAdapter extends RecyclerView.Adapter<ExhibitDetailsAdapter.IntroContentViewHolder> {

    private final List<String> content;

    public ExhibitDetailsAdapter(List<String> content) {
